        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'homePagePublicar',
              builder: (context, params) => params.isEmpty
                  ? const NavBarPage(initialPage: 'homePage_Publicar')
                  : const HomePagePublicarWidget(),
            ),
            FFRoute(
              name: 'createProperty360',
              path: 'createProperty360',
              builder: (context, params) => CreateProperty360Widget(
                idProperty: params.getParam(
                  'idProperty',
                  ParamType.String,
                ),
              ),
            ...
            FFRoute(
              name: 'createProperty360Panos',
              path: 'createProperty360Panos',
              builder: (context, params) => CreateProperty360PanosWidget(
                idProperty: params.getParam(
                  'idProperty',
                  ParamType.String,
                ),
                idVirtualTour: params.getParam(
                  'idVirtualTour',
                  ParamType.String,
                ),
              ),
            ...
            FFRoute(
              name: 'createProperty360Dialog',
              path: 'createProperty360Dialog',
              builder: (context, params) => CreateProperty360DialogWidget(
                idProperty: params.getParam(
                  'idProperty',
                  ParamType.String,
                ),
            ...
            FFRoute(
              ...
              builder: (context, params) => CreateCalendarDateWidget(
                idProperty: params.getParam(
                  'idProperty',
                  ParamType.String,
                ),
            ...
            FFRoute(
              name: 'createCalendarGpiTours',
              path: 'createCalendarGpiTours',
              builder: (context, params) => CreateCalendarGpiToursWidget(
                idProperty: params.getParam(
                  'idProperty',
                  ParamType.String,
                ),
            ...
            FFRoute(
              name: 'calendarUserCreate',
              path: 'calendarUserCreate',
              builder: (context, params) => CalendarUserCreateWidget(
                idProperty: params.getParam(
                  'idProperty',
                  ParamType.String,
                ),
            ...
            FFRoute(
              name: 'calendarDisponibilidadUser',
              path: 'calendarDisponibilidadUser',
              builder: (context, params) => CalendarDisponibilidadUserWidget(
                idProperty: params.getParam(
                  'idProperty',
                  ParamType.String,
                ),
            ...
            FFRoute(
              name: 'createProperty360DialogPerfil',
              path: 'createProperty360DialogPerfil',
              builder: (context, params) => CreateProperty360DialogPerfilWidget(
                idProperty: params.getParam(
                  'idProperty',
                  ParamType.String,
                ),
            ...
            FFRoute(
              name: 'createCalendarDateGPI',
              path: 'createCalendarDateGPI',
              builder: (context, params) => CreateCalendarDateGPIWidget(
                idProperty: params.getParam(
                  'idProperty',
                  ParamType.String,
                ),
            ...
            FFRoute(
              name: 'editProperty_3_GPI',
              path: 'editProperty3GPI',
              asyncParams: {
                'propertyRef':
                    getDoc(['properties'], PropertiesRecord.fromSnapshot),
              },
              builder: (context, params) => EditProperty3GPIWidget(
                propertyRef: params.getParam(
                  'propertyRef',
                  ParamType.Document,
                ),
            ...
            FFRoute(
              name: 'homePage_Autorizate',
              path: 'homePageAutorizate',
              builder: (context, params) => const HomePageAutorizateWidget(),
            ),
            FFRoute(
              name: 'propertyDetailsAtorize',
              path: 'propertyDetailsAutorize',
              asyncParams: {
                'propertyRef':
                    getDoc(['properties'], PropertiesRecord.fromSnapshot),
              },
              builder: (context, params) => PropertyDetailsAtorizeWidget(
                propertyRef: params.getParam(
                  'propertyRef',
                  ParamType.Document,
                ),
            ...
            FFRoute(
              name: 'aCrearNombrePano',
              path: 'aCrearNombrePano',
              builder: (context, params) => ACrearNombrePanoWidget(
                idProperty: params.getParam(
                  'idProperty',
                  ParamType.String,
                ),
            ...
            FFRoute(
              name: 'aConsultarNombrePano',
              path: 'aConsultarNombrePano',
              builder: (context, params) => AConsultarNombrePanoWidget(
                idProperty: params.getParam(
                  'idProperty',
                  ParamType.String,
                ),
            ...
            FFRoute(
              name: 'homePage_Favoritos',
              path: 'homePageFavoritos',
              builder: (context, params) => HomePageFavoritosWidget(
                listFavs: params.getParam<DocumentReference>(
                  'listFavs',
                  ParamType.DocumentReference,
                  isList: true,
