                  ...
                  children: [
                    Expanded(
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'tipbgz8l' /* Let us know what you thought o... */,
                          ),
                          textAlign: TextAlign.start,
                          style:
                    ...
                    children: [
                      Expanded(
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '4ml9og4a' /* How would you rate it? */,
                            ),
                            textAlign: TextAlign.start,
                            style:
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      hintText: FFLocalizations.of(context).getText(
                        'i2zqamur' /* Please leave a description of ... */,
                      ),
                      hintStyle:
                          FlutterFlowTheme.of(context).bodyMedium.override(
                                fontFamily: 'Poiret One',
