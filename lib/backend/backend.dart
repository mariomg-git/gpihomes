...
import 'schema/virtual_tours_record.dart';
import 'schema/niveles_record.dart';
import 'schema/tours_record.dart';
import 'schema/agenda_gpi_record.dart';
import 'schema/agendar_tours_users_record.dart';
...
export 'schema/virtual_tours_record.dart';
export 'schema/niveles_record.dart';
export 'schema/tours_record.dart';
export 'schema/agenda_gpi_record.dart';
export 'schema/agendar_tours_users_record.dart';
...
/// Functions to query VirtualToursRecords (as a Stream and as a Future).
Future<int> queryVirtualToursRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      VirtualToursRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<VirtualToursRecord>> queryVirtualToursRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      VirtualToursRecord.collection,
      VirtualToursRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<VirtualToursRecord>> queryVirtualToursRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query NivelesRecords (as a Stream and as a Future).
Future<int> queryNivelesRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      NivelesRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<NivelesRecord>> queryNivelesRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      NivelesRecord.collection(parent),
      NivelesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<NivelesRecord>> queryNivelesRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
/// Functions to query AgendaGpiRecords (as a Stream and as a Future).
Future<int> queryAgendaGpiRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      AgendaGpiRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<AgendaGpiRecord>> queryAgendaGpiRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      AgendaGpiRecord.collection,
      AgendaGpiRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<AgendaGpiRecord>> queryAgendaGpiRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query AgendarToursUsersRecords (as a Stream and as a Future).
Future<int> queryAgendarToursUsersRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      AgendarToursUsersRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<AgendarToursUsersRecord>> queryAgendarToursUsersRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      AgendarToursUsersRecord.collection,
      AgendarToursUsersRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<AgendarToursUsersRecord>> queryAgendarToursUsersRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
