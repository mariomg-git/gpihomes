...
Map<String, dynamic> createBookingsRecordData({
  ...
  int? numberBooks,
  DateTime? fInicioContrato,
}) {
  final firestoreData = mapToFirestore(
    <String, dynamic>{
      'hostRef': hostRef,
      'numberBooks': numberBooks,
      'fInicioContrato': fInicioContrato,
    }.withoutNulls,
  );
...
class BookingsRecordDocumentEquality implements Equality<BookingsRecord> {
  ...
  bool equals(BookingsRecord? e1, BookingsRecord? e2) {
    return e1?.hostRef == e2?.hostRef &&
        ...
        e1?.fInicioContrato == e2?.fInicioContrato;
  }

  @override
  int hash(BookingsRecord? e) => const ListEquality()
      .hash([e?.hostRef, e?.numberBooks, e?.fInicioContrato]);
