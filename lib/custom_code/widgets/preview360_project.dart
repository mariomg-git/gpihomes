...
class Preview360Project extends StatefulWidget {
  const Preview360Project({
    super.key,
    this.width,
    this.height,
  });
  ...
  @override
  State<Preview360Project> createState() => _Preview360ProjectState();
}

class _Preview360ProjectState extends State<Preview360Project> {
  int _currentIndex = 0;
