...
class CalendarDisponibilidad extends StatefulWidget {
  const CalendarDisponibilidad({
    super.key,
    this.width,
    this.height,
    this.idPropiedad,
  ...
  @override
  State<CalendarDisponibilidad> createState() => _CalendarDisponibilidadState();
}

class _CalendarDisponibilidadState extends State<CalendarDisponibilidad> {
