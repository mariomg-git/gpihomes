...
import 'property_details_atorize_model.dart';
export 'property_details_atorize_model.dart';

class PropertyDetailsAtorizeWidget extends StatefulWidget {
  const PropertyDetailsAtorizeWidget({
    super.key,
    this.propertyRef,
  });
  ...
  @override
  State<PropertyDetailsAtorizeWidget> createState() =>
      _PropertyDetailsAtorizeWidgetState();
}

class _PropertyDetailsAtorizeWidgetState
    extends State<PropertyDetailsAtorizeWidget> with TickerProviderStateMixin {
  late PropertyDetailsAtorizeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PropertyDetailsAtorizeModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ReviewsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ReviewsRecord> propertyDetailsAtorizeReviewsRecordList =
            snapshot.data!;

        return Title(
            title: 'propertyDetailsAtorize',
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      functions.ratingSummaryList(
                                          propertyDetailsAtorizeReviewsRecordList
                                              .toList()),
                                      style: FlutterFlowTheme.of(context)
                                          .bodySmall
                                          .override(
