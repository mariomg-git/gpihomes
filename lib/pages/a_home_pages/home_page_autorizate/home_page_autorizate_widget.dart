...
import 'home_page_autorizate_model.dart';
export 'home_page_autorizate_model.dart';

class HomePageAutorizateWidget extends StatefulWidget {
  const HomePageAutorizateWidget({super.key});

  @override
  State<HomePageAutorizateWidget> createState() =>
      _HomePageAutorizateWidgetState();
}

class _HomePageAutorizateWidgetState extends State<HomePageAutorizateWidget> {
  late HomePageAutorizateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePageAutorizateModel());
