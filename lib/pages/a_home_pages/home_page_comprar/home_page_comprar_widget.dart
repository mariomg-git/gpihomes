...
class HomePageComprarWidget extends StatefulWidget {
  const HomePageComprarWidget({super.key});

  @override
  State<HomePageComprarWidget> createState() => _HomePageComprarWidgetState();
}

class _HomePageComprarWidgetState extends State<HomePageComprarWidget> {
  late HomePageComprarModel _model;
