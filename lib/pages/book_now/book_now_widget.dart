...
import '/components/modal_calebdar_inicio_widget.dart';
          ...
          body: Column(
            ...
            children: [
                                          ...
                                          return Padding(
                                            ...
                                            child: SizedBox(
                                              height: MediaQuery.sizeOf(context)
                                                      .height *
                                                  0.9,
                                              child: ModalCalebdarInicioWidget(
                                                idProp: widget.propertyDetails!
                                                    .reference.id,
                                                fDisponible: widget
                                                    .propertyDetails
                                                    ?.fechaDisponibleProp,
                              ...
                              child: Padding(
                                ...
                                child: FlutterFlowChoiceChips(
                                  options: [
                                    ...
                                    ChipData(
                                        FFLocalizations.of(context).getText(
                                      'byxlxe7q' /* No Breakfast */,
                                    )),
                                    ChipData(
                                        FFLocalizations.of(context).getText(
                                      'rq2udjek' /* Hot Tub Access */,
                                    )),
                                    ChipData(
                                        FFLocalizations.of(context).getText(
                                      'i1si04dx' /* No Access */,
                                  ...
                                  controller:
                                      _model.breakfastValueController ??=
              ...
              StreamBuilder<UsersRecord>(
                stream:
                    UsersRecord.getDocument(widget.propertyDetails!.userRef!),
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          await tripsRecordReference.set(createTripsRecordData(
                            ...
                            cancelTrip: false,
                            upcoming: true,
                            fInicioContrato: FFAppState().fInicioContrato,
                          ));
