                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              keyboardType: TextInputType.number,
                              validator: _model
                                  .cleaningFeeTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                          Padding(
                          ...
                          Padding(
                            ...
                            child: Material(
                              ...
                              child: SwitchListTile.adaptive(
                                ...
                                subtitle: Text(
                                  FFLocalizations.of(context).getText(
                                    '4aiiz5vw' /* Turn this on for guests to sta... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                        ...
                        onPressed: () async {
                          await widget.propertyRef!.reference
                            ...
                            taxRate: double.tryParse(
                                _model.taxRateTextController.text),
                            notes: _model.notesTextController.text,
                            cleaningFee: int.tryParse(
                                _model.cleaningFeeTextController.text),
