...
class CreateProperty3Model extends FlutterFlowModel<CreateProperty3Widget> {
  ...
  double? pricePropiedad;

  ///  State fields for stateful widgets in this page.

  final formKey = GlobalKey<FormState>();
  // State field(s) for roomsController widget.
  int? roomsControllerValue;
  // State field(s) for bathsController widget.
  int? bathsControllerValue;
