...
class _EditProperty1WidgetState extends State<EditProperty1Widget> {
  ...
  void initState() {
    ...
    _model.propertyAddressTextController ??=
        TextEditingController(text: widget.propertyRef?.propertyCity);
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.propertyDescriptionTextController,
                                  focusNode:
                                      _model.propertyDescriptionFocusNode,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'xh9loelk' /* Neighborhood or city… */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
