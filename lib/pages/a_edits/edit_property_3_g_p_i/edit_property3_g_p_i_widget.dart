...
import 'edit_property3_g_p_i_model.dart';
export 'edit_property3_g_p_i_model.dart';

class EditProperty3GPIWidget extends StatefulWidget {
  const EditProperty3GPIWidget({
    super.key,
    this.propertyRef,
  });
  ...
  @override
  State<EditProperty3GPIWidget> createState() => _EditProperty3GPIWidgetState();
}

class _EditProperty3GPIWidgetState extends State<EditProperty3GPIWidget> {
  late EditProperty3GPIModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditProperty3GPIModel());
                          ...
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 4.0, 0.0, 0.0),
                              child: TextFormField(
                                controller: _model.pricePropiedadTextController,
                                focusNode: _model.pricePropiedadFocusNode,
                                obscureText: false,
